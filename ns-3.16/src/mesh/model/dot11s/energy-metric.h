...
#include "/home/renoire/git/fuzzylite/fuzzylite/fl/fuzzylite.h"
#include "/home/renoire/git/fuzzylite/fuzzylite/fl/Headers.h"
#include "/home/renoire/git/fuzzylite/fuzzylite/fl/Engine.h"
namespace ns3 {
namespace dot11s {
/**
 * \ingroup dot11s
 ...
 */
class EnergyMetricCalculator : public Object
{
public:
  EnergyMetricCalculator (Ptr<LiIonEnergySource> es);
  EnergyMetricCalculator ();
  static TypeId GetTypeId ();
  uint32_t CalculateMetric (Mac48Address peerAddress, Ptr<MeshWifiInterfaceMac> mac, uint32_t hopcount);
...
private:
  ...
  Ptr<LiIonEnergySource> m_energySource;
